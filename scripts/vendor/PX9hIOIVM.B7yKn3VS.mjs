...
import { T as f, a as p, r as re, t as ie } from "./motion.BtOE26Nw.mjs";
import {
  A as m,
  At as h,
  H as g,
...
e(() => {
  (l(),
    ...
    (U = g(H)),
    (W = g(P)),
    (G = h(P, { nodeId: `pBR1Ew0r8`, override: pe, scopeId: `PX9hIOIVM` })),
    (K = se(ae(h(f.a, { nodeId: `HK2sXlagE`, override: fe, scopeId: `PX9hIOIVM` })))),
    (q = `framer-6jWyo`),
    ...
    (Q = x(
      s(function (e, t) {
        let n = i(null),
          r = t ?? n,
          a = te(),
          { activeLocale: s, setLocale: ee } = ue();
        ce();
        let { style: l, className: u, layoutId: ne, variant: d, ...p } = xe(e),
          {
            baseVariant: ie,
            classNames: m,
            ...
            setVariant: y,
            variants: b,
          } = oe({ defaultVariant: `HK2sXlagE`, ref: r, variant: d, variantClassNames: J }),
          x = Se(e, b),
          S = _(q);
        return o(re, {
          id: ne ?? a,
            ...
            children: o(ye, {
              ...
              children: o(le, {
                ...
                children: c(K, {
                  ...
                  __targetOpacity: 1,
                  className: `${_(S, `framer-n0ccwk`, u, m)} framer-bmpgw8`,
    ...
    b(Q, [{ explicitInter: !0, fonts: [] }, ...U, ...W], { supportsExplicitInterCodegen: !0 }),
    ($ = {
      exports: {
...
//# sourceMappingURL=PX9hIOIVM.B7yKn3VS.mjs.map
